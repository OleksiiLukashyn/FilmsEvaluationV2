...
namespace FilmsEvaluationV2.Controllers
{
    ...
    public class DirectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Awards,FirstName,LastName,Gender,Born,Description")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Awards,FirstName,LastName,Gender,Born,Description")] Director director)
        {
            if (id != director.Id)
            {
                return NotFound();
